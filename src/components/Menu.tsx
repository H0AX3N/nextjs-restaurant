...
export default function Menu() {
    ...
    return (
        <div>
            ...
            {open && <div className='flex flex-col items-center justify-center gap-8 text-3xl bg-red-500 text-white absolute left-0 top-24 h-[calc(100vh-6rem)] w-full z-10'>
                {links.map(item => (
